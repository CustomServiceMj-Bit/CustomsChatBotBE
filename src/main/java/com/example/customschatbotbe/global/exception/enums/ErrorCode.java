...
public enum ErrorCode {
    ...
    FETCH_ERROR_MESSAGE(HttpStatus.INTERNAL_SERVER_ERROR, "TRACK-DELIVERY-003", "응답 도중 예기치 못한 오류가 발생했습니다."),
    INVALID_BL_NUMBER_MESSAGE(HttpStatus.BAD_REQUEST, "TRACK-DELIVERY-004", "BL 번호 형식이 올바르지 않습니다."),
    ;
